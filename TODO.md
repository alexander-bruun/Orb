...
12. Add Tauri mobile builds (Android APK, iOS IPA) to the CI release pipeline. Requires Android NDK + signing keys and Apple Developer certificate as GitHub secrets.
13. Replace placeholder Tauri app icons with proper Orb branding.
